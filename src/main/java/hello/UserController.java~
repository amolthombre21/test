...
public class UserController extends WebMvcConfigurerAdapter {
	...
	public static DBCollection getCollection(String collectionName) throws UnknownHostException, MongoException {
		String uri = "mongodb://ds047940.mongolab.com:47940/";
		MongoCredential mongoCredential = MongoCredential.createMongoCRCredential("amolthombre", "digital_wallet", "amolthombre".toCharArray());
		MongoClientURI mongoClientURI = new MongoClientURI(uri);

		MongoClient mongoClient = new MongoClient(mongoClientURI);

		DB db = mongoClient.getDB("digital_wallet");
		db.authenticate("amolthombre", "amolthombre".toCharArray());
	...
	public ResponseEntity<User> createUser(@RequestBody @Valid User user, BindingResult bindingResult) throws UnknownHostException, MongoException {
